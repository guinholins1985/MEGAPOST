...
const visualMediaCategories: VisualMediaCategory[] = [
    {
        ...
        items: [
            { id: 'white_background', title: "Fundo Branco (Marketplace)", description: "Ideal para Amazon, Mercado Livre. Remove o fundo e cria uma imagem limpa e profissional.", prompt: "Remove the background completely and replace it with a clean, professional, solid white background. The product should be perfectly lit and centered. Generate a photorealistic 4K image." },
            { id: 'instagram_post_promo', title: "Post Instagram (1:1)", description: "Imagem de lifestyle, quadrada, com espaço para adicionar texto promocional.", prompt: "Create a high-quality, professional image for an Instagram post (1:1 aspect ratio). The image should be a visually appealing lifestyle photo featuring a person happily using or interacting with the product. Leave empty space where promotional text could be added later." },
            { id: 'facebook_post_ad', title: "Anúncio para Facebook (1.91:1)", description: "Imagem horizontal otimizada para anúncios, com espaço para chamada de ação (CTA).", prompt: "Create a compelling image for a Facebook ad (1.91:1 aspect ratio). The scene should be eye-catching and show a person enjoying the benefits of the product, with clean space for a call-to-action to be added later." },
        ]
    },
    {
        categoryTitle: "Mockups Realistas",
        items: [
            { id: 'mockup_with_model_lifestyle', title: "Mockup com Modelo (Uso Cotidiano)", description: "Mostra o produto sendo usado em um cenário do dia a dia para criar conexão.", prompt: "Generate a realistic lifestyle mockup showing this product being used by a person in a home environment. The scene should feel authentic and relatable. The image aspect ratio should be 4:5." },
            { id: 'mockup_product_focused', title: "Mockup Foco no Produto", description: "Produto em um ambiente estilizado (mármore, madeira) com iluminação dramática.", prompt: "Generate a photorealistic mockup of this product on a stylish, minimalist surface (like marble or wood). Use dramatic lighting and shadows to create a premium feel. This is a hero shot." },
        ]
    },
    {
        categoryTitle: "Banners e Mídias Verticais",
        items: [
            { id: 'banner_promo_coupon', title: "Banner Promocional (16:9)", description: "Banner para topo de site ou anúncios, com área para um código de cupom.", prompt: "Create a compelling promotional banner for this product (16:9 aspect ratio). The background should be eye-catching, with a clear area where a coupon code can be added later." },
            { id: 'banner_facebook_cover', title: "Capa para Facebook", description: "Banner largo (formato ~2.7:1) para a capa da sua página do Facebook.", prompt: "Create a wide banner image suitable for a Facebook cover photo (approximately 2.7:1 aspect ratio). The product should be featured prominently, but placed to the right, leaving space on the left for the profile picture and page buttons. The overall design should be clean and professional, with empty space for text to be added." },
            { id: 'vertical_tiktok_reels', title: "Mídia para TikTok/Reels (9:16)", description: "Imagem vertical que simula um frame de vídeo, otimizada para engajamento.", prompt: "Generate a high-energy, visually engaging image that looks like a still frame from a TikTok video or Instagram Reel (9:16 aspect ratio). The image should feature a person interacting with the product in a fun and dynamic way. The style should be modern and trendy, with empty space for text overlays." },
            { id: 'vertical_whatsapp_status', title: "Status para WhatsApp (9:16)", description: "Imagem vertical para compartilhar ofertas e novidades diretamente no Status.", prompt: "Create a clean and clear image for a WhatsApp Status update (9:16 aspect ratio). The image should showcase the product clearly, with a simple, attractive background. It needs to have plenty of empty space for adding promotional text or product information later." }
        ]
    },
    {
        categoryTitle: "Conteúdos Educativos e Complementares",
        items: [
            { id: 'infographic_benefits', title: "Infográfico Simples de Benefícios", description: "Imagem (1:1) com ícones e espaço para destacar 3 benefícios do produto.", prompt: "Create a simple, visually appealing infographic template for an Instagram post (1:1 aspect ratio). It should have spaces for three key benefits, using modern icons as placeholders, but without any text. Leave clean areas for text to be added later." },
            { id: 'youtube_thumbnail', title: "Thumbnail para YouTube (16:9)", description: "Cria uma thumbnail otimizada para cliques (CTR) com espaço para título.", prompt: "Generate a high-click-through-rate (CTR) YouTube thumbnail for a review of this product. It should be vibrant and high-contrast, featuring a person with an expressive, excited, or surprised facial expression next to the product. The product must look appealing, with significant empty space for a catchy title to be added later. The aspect ratio must be 16:9." }
        ]
    }
];
